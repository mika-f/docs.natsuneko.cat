...
export const Heading3 = ({ children }: Props) => {
  return (
    <h3 className="scroll-m-20 text-2xl pb-4 mt-8 font-semibold tracking-tight first:mt-0">
      {children}
    </h3>
  );
};
...
export const Heading4 = ({ children }: Props) => {
  return (
    <h4 className="scroll-m-20 text-xl pb-4 mt-8 font-semibold tracking-tight">
      {children}
    </h4>
  );
};
