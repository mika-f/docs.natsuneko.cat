...
Pro では、Catalyst 上に広告を掲載することが可能です。広告掲載については、詳しくは[広告ポリシー](05-ads.md) を参照してください。
...
アカウントの削除を希望する場合は、 Twitter @6jz もしくは Discord サーバーにてご連絡ください。
アカウントの削除には、本人確認のための情報が必要となります。削除を希望するアカウントのユーザー名、ログインにしているソーシャルプロバイダーとそのメールアドレス、もしくは直接登録したメールアドレスを明記してください。
アカウントの削除には、最大で 30 日程度かかる場合があります。ご了承ください。
なお、アカウントの削除が完了した後も、投稿した写真やアルバムなどのコンテンツは完全には削除されない場合があります。ご了承ください。

### 削除されないデータについて

次のデータはアカウント削除時に @ghost アカウントが所持していたものとマークされ、削除されません：

- Catalyst - コンテスト応募作品
- Remuria - 公開、および非表示リポジトリ
