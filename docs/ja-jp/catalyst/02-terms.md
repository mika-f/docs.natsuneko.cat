...
ユーザーは、本サービスの利用にあたり、以下に該当する、または該当するおそれのあるコンテンツの投稿および行為を行ってはなりません。
...
## 第 8 条（ユーザー生成コンテンツの取り扱い）

本サービスは、ユーザーがコンテンツ（画像、テキストその他一切の情報）を投稿・共有できる機能（以下「ユーザー生成コンテンツ」といいます）を提供します。
ユーザーは、自らが投稿するコンテンツについて一切の責任を負うものとします。

運営者は、ユーザー生成コンテンツに関して、本規約および法令に違反する可能性がある場合、当該コンテンツの削除、非表示化 (サイレンス)、NSFW フラグの付与、その他必要な措置を講じる権利を有します。

## 第 9 条（通報およびブロック機能）

ユーザーは、本サービス上の不適切なコンテンツまたは他のユーザーの行為について、運営者に対して通報することができます。
また、ユーザーは、特定のユーザーをブロックすることにより、当該ユーザーからのコンテンツを自身のフィード等に表示しないよう設定することができます。

運営者は、通報された内容を確認し、必要に応じて適切な措置を講じます。

## 第 10 条（不適切コンテンツへの対応）

運営者は、ユーザーから通報された不適切なコンテンツについて、合理的な範囲で速やかに確認を行い、原則として24時間以内に、当該コンテンツの削除、非表示化、 NSFW フラグの付与、または当該ユーザーの利用制限等の措置を講じます。

## 第 11 条（違反時の措置）

運営者は、ユーザーが本規約に違反したと判断した場合、以下の措置を講じることができます。

- コンテンツの削除または非表示化または NSFW フラグの付与
- 一時的なアカウント停止
- 永続的なアカウント削除
- その他運営者が必要と判断する措置

これらの措置は、事前の通知なく実施される場合があります。
